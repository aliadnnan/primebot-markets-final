...
function getEmbedUrl(url: string) {
  try {
    ...
    if (host === 'youtube.com' || host === 'm.youtube.com') {
      ...
      if (embedIndex >= 0 && parts[embedIndex + 1]) return `https://www.youtube.com/embed/${parts[embedIndex + 1]}?autoplay=1&mute=1&playsinline=1`
    }
    if (host === 'youtu.be') {
              ...
              <div className="bg-black rounded-lg overflow-hidden">
                <div className="relative w-full aspect-video">
                  {isDirectVideo(selectedVideo.video_url) ? (
                    ...
                    >
                      <source src={getEmbedUrl(selectedVideo.video_url)} type="video/mp4" />
